...
| `walk_forward` | portfolio execution replay | Portfolio robustness authority: purged, embargoed calendar folds on the real timeline (`RESET_FOR_REGIME_ROBUSTNESS`; not the continuous replay). |
