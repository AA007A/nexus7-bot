...
def install(TradingEngine, log) -> None:
    ...
    log.info(
        ...
        "partial-TP execution, non-overridable drawdown hard-gate, final risk-authoritative "
        ...
        "stop-stress gate, startup readiness final notification via operator run owner, delegated drawdown/exit policy, strict NEXUS "
